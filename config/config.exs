...
config :ash_gql_sub_bug, AshGqlSubBugWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AshGqlSubBugWeb.ErrorHTML, json: AshGqlSubBugWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: AshGqlSubBug.PubSub,
  live_view: [signing_salt: "j0iGtnkP"]
...
config :ash_gql_sub_bug, AshGqlSubBug.Mailer, adapter: Swoosh.Adapters.Local
